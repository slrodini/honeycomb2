...
template <typename T>
struct TimeUnit {
      static std::string get() { return "Unknown time unit"; }
};

template <>
struct TimeUnit<nanoseconds> {
      static std::string get() { return "nanoseconds"; }
};

template <>
struct TimeUnit<microseconds> {
      static std::string get() { return "microseconds"; }
};

template <>
struct TimeUnit<milliseconds> {
      static std::string get() { return "milliseconds"; }
};
